                ...
                <div className="overflow-x-auto max-h-96 overflow-y-auto">
                  <Table>
                    ...
                    <TableBody>
                      {events.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={8} className={`text-center py-8 ${isDarkMode ? 'text-gray-400' : 'text-muted-foreground'}`}>
                              ...
                              {event.aggregated ? (
                                <div>
                                  ...
                                  <div className="text-xs text-gray-500 mt-1">
                                    {event.originalCount} events in 1 minute
                                  </div>
                                  <div className="text-xs">
                                    {event.firstSeen ? `Since ${new Date(event.firstSeen).toLocaleString()}` : 'Unknown'}
                                  </div>
                                </div>
                              ) : (
                                <div>{event.name}</div>
